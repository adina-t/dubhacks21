...
window.initMap = function() {
  ...
  // Adding Markers
  addMarkers(microwaves, map);
  addMarkers(bikeStorages, map);
  addMarkers(cafes, map);
  addMarkers(restaurants, map);
  addMarkers(studySpaces, map);
  addMarkers(busStops, map);
...
//
function addMarkers(itemType, Map) {
